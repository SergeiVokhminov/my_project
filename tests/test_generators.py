...
def test_transaction_descriptions(user_list: List[Dict[str, dict]]) -> None:
    """Тестирование функции вывода наименования операций."""
    ...
    for item in descriptions:
        assert next(description) == item


@pytest.mark.parametrize("start, stop, expected_result", [(1, 1, ("0000 0000 0000 0001"))])
def test_card_number_generator(start: int, stop: int, expected_result: str) -> None:
    """Тестирование функции вывода номера карты."""
